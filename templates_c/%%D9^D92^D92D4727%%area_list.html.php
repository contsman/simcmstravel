<?php /* Smarty version 2.6.18, created on 2016-08-03 15:46:31
...
<td align="left"  class="fb"><?php echo $this->_tpl_vars['arealist']['name']; ?>
 <?php if ($this->_tpl_vars['arealist']['ishot'] == 1): ?><span class="red"> 热门</span><?php endif; ?></td>
<td align="center"><?php if ($this->_tpl_vars['arealist']['actived'] == 1): ?>是<?php else: ?><span class="orange01">否</span><?php endif; ?></td>
<td align="right" width="130">[<a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?mod=area&ac=show&actived=<?php if ($this->_tpl_vars['arealist']['actived'] == 1): ?>0<?php else: ?>1<?php endif; ?>&id=<?php echo $this->_tpl_vars['arealist']['id']; ?>
"><?php if ($this->_tpl_vars['arealist']['actived'] == 0): ?>不显示<?php else: ?>显示<?php endif; ?></a>] [<a href="<?php echo $this->_tpl_vars['adminpage']; ?>
...
?mod=area&ac=show&actived=<?php if ($this->_tpl_vars['citylist']['actived'] == 1): ?>0<?php else: ?>1<?php endif; ?>&id=<?php echo $this->_tpl_vars['citylist']['id']; ?>
