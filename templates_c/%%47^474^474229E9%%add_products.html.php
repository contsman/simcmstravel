<?php /* Smarty version 2.6.18, created on 2014-02-04 22:32:58
	...
	$(function() {
		 $('#file_upload').uploadify({
			...
			'onComplete':function(event,queueId,fileObj,response,data){
				...
				$('#piclist').append('<li id="'+arr_picids[0]+'"><img src="'+response+'"><p><span style="cursor:pointer">删除</span><input type="hidden" name="p_pics[]" value="'+response+'"></p></li>');//在页面上显示文件相对路径
			},
