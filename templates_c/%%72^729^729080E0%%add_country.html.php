...
<script type="text/javascript">
	$(function() {
		...
		$("#countryform").skygqCheckAjaxForm({
			items			: items_array
		});
	});
</script>
...
<form name="form1" id="countryform" method="post" action="<?php echo $this->_tpl_vars['adminpage']; ?>
?mod=country">
...
<th>排序：</th>
<td>
	<input type="text" name="orderid" size="5" value="<?php echo $this->_tpl_vars['country']['l_orderid']; ?>
">
</td>
</tr>
<tr>
...
">
	<input type="hidden" name="id" value="<?php echo $this->_tpl_vars['country']['id']; ?>
">
	<input type="hidden" name="parentid" value="<?php echo $this->_tpl_vars['country']['parentid']; ?>
">
