<?php /* Smarty version 2.6.18, created on 2014-01-24 11:56:57
         compiled from admin/products_html.html */ ?>
...
?mod=create_html&ac=products&op=1');"/>
						</p>
						<p>更新最新发布的
							<input type="text" name="productsnum" size="5" value="20">
							条信息
							<input type="button" class="button" value="开始更新" onclick="submithtml('<?php echo $this->_tpl_vars['adminpage']; ?>
?mod=create_html&ac=products&op=2');"/>
						</p>
						<p>更新发布时间从
...
">
							...
							的信息
							<input type="button" class="button" value="开始更新" onclick="submithtml('<?php echo $this->_tpl_vars['adminpage']; ?>
?mod=create_html&ac=products&op=3');"/>
						</p>
						<p>更新ID从
							...
							的信息
							<input type="button" class="button" value="开始更新" onclick="submithtml('<?php echo $this->_tpl_vars['adminpage']; ?>
?mod=create_html&ac=products&op=4');"/>
						</p>
					</div>
				</td>
			</tr>
