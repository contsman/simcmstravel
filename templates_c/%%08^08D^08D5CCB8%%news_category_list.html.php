<?php /* Smarty version 2.6.18, created on 2014-01-24 11:56:03
...
<body>
<div class="tablenav"><span class="title">您的位置：新闻管理 <span class="navfont">>></span> 分类管理</span><span class="refresh"><a href="javascript:location.reload() 
">刷新</a></span></div>
...
?mod=news_category&ac=list">管理分类</a></li>
				<li><a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?mod=news_category&ac=add">添加分类</a></li>
			</ul>
		</div>
	</div>
	<form action="<?php echo $this->_tpl_vars['adminpage']; ?>
?mod=news_category" method="post" name="form">
...
?mod=news_category&ac=bulksort','更新排序');" title="请选择后操作">更新排序</a>
		</td>
	</tr>
	</table>
	</form>
