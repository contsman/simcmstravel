...
E_D("replace into `travel_products_category` values('55','0','出境游','','','','4','1','0');");
E_D("replace into `travel_products_category` values('72','0','主题游','','','','3','1','0');");
E_D("replace into `travel_products_category` values('58','0','国内游','','','','1','1','0');");
E_D("replace into `travel_products_category` values('110','58','海滨','','','','0','1','1');");
E_D("replace into `travel_products_category` values('71','0','自助游','','','','2','1','0');");
