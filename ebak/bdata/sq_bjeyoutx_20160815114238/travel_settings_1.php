...
E_D("replace into `travel_settings` values('title','北京首都旅游网');");
E_D("replace into `travel_settings` values('keywords','北京首都旅游网');");
E_D("replace into `travel_settings` values('description','北京首都旅游网');");
E_D("replace into `travel_settings` values('sitename','北京首都旅游网');");
...
E_D("replace into `travel_settings` values('email','1121756646@qq.com');");
