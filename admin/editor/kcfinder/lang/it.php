...
$lang = array(
    ...
    "Il file 猫 stato caricato parzialmente.",

    "No file was uploaded." =>
    "Nessun file 猫 stato caricato",
    ...
    "Immagine troppo grande e/o non pu貌 essere rimpicciolita",

    "Cannot create {dir} folder." =>
    "La cartella {dir} non pu貌 essere creata.",
    ...
    "Il file .htaccess 猫 corrotto. Impossibile riscriverlo!",
    ...
    "Il nome della cartella non pu貌 iniziare con'.'",
    ...
    "Il nome del file non pu貌 iniziare con '.'",
    ...
    "Non 猫 possibile caricare questi files.",
    ...
    "Questo file 猫 gi脿 aggiunto alla Clipboard.",
    ...
    "Non 猫 possibile rinominare la cartella.",

    "Non-existing directory type." =>
    "Il tipo di cartella non esiste.",

    "Cannot delete the folder." =>
    "Non 猫 possibile cancellare la cartella.",
    ...
    "Il file selezionato non 猫 rimovibile.",
    ...
    "Un file o cartella con questo nome gi脿 esiste.",
